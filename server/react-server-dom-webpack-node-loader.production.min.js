// i copied this because the import was being dumb
/**
 * @license React
  ...
  for (let i = 0; i < names.length; i++) {
    ...
    if (name === "default") {
      ...
      newSrc += "throw new Error(" +
        JSON.stringify(
          "Attempted to call the default export of " + url +
            " from the server" +
      ...
      newSrc += "throw new Error(" +
        JSON.stringify(
          "Attempted to call " + name + "() from the server but " + name +
            " is on the client. " +
...
async function transformModuleIfNeeded(source, url, loader) {
  ...
  // bother parsing.
  if (
    source.indexOf("use client") === -1 && source.indexOf("use server") === -1
  ) {
    return source
  }
